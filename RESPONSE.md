...
## VIII. Python Implementation Status

The research framework is now converted into executable logic in:

- `pre_pump_engine.py`
- `test_pre_pump_engine.py`
...
6. Unit tests for high-probability and low-signal scenarios.
